                    ...
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                    title=" Entrer le Num de la facture  " required>
                            </div>
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">Le Nom de L'Entreprise</label>
                                <input type="text" class="form-control" id="inputNameE" name="inputNameE"
                                title="  Entrer le Nom de L'entreprise " required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="produit" class="form-control SlectBox" onclick="console.log($(this).val())"
                            ...
                            <div class="col">
                                ...
                                title="  Entrer l'adresse de L'entreprise " required>
                            </div>
                            <div class="col">
                                <label for="inputName" class="control-label">Telephone Entreprise</label>
                                <input type="tel" class="form-control" id="tel_Entreprise" name="tel_Entreprise"
                                title="  Entrer Tel de L'entreprise " required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control " name="prenom_client" placeholder="Prenom du Client"
                                    type="text" required>
                            </div>
                            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Amount_Commission"
                                    name="Amount_Commission" title="Entrer Le Prix    "
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="" selected disabled>Determiner la valeur du TVA  </option>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="email_client" placeholder="Email"
                                    type="email" required>
                            </div>
                        ...
                        <h5 class="card-title">Telecharger Facture</h5>
