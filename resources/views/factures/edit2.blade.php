                ...
                <form action="{{ route('factures.update', $facture->id) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                            value="{{ $facture->title }}" required>
                    </div>
                    <div class="form-group">
                        <label for="nomClient">nom Client</label>
                        <input type="text" class="form-control" id="nomClient" name="nomClient"
                            value="{{ $facture->nomClient }}" required>
                    </br>    
                        <label for="description">description</label>
                        <textarea class="form-control" id="description" name="description" rows="3" required>{{ $facture->description }}</textarea>
                    </div>
