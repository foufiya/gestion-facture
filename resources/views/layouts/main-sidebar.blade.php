...
<aside class="app-sidebar sidebar-scroll">
     <div class="main-sidebar-header active">
       <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'home')) }}"><img
                src="{{ URL::asset('assets/img/faces/logo.jpeg') }}" class="main-logo" alt="logo"></a>
        <a class="desktop-logo logo-dark active" href="{{ url('/' . ($page = 'home')) }}"><img
                src="{{ URL::asset('assets/img/brand/logo.jpeg') }}" class="main-logo dark-theme"
                alt="logo"></a>
    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/man.png')}}"><span class="avatar-status profile-status bg-green"></span>
                </div>
                <div class="user-info">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">Scanf</li>
            <li class="slide">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'factures')) }}">Liste des factures</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'indexPayee')) }}">Factures payées</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'facture_imapaid')) }}">Factures impayées</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'indexPp')) }}">Factures partiellement
                            payées</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'Rapport')) }}">Rapports Factures</a></li>
                    {{-- <li><a class="slide-item" href="{{ url('/' . ($page = 'darggablecards')) }}">Rapports clients</a></li> --}}
                </ul>
            </li>

            <li class="side-item side-item-category">Entreprises</li>
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='clients') }}">Liste des clients</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='entreprises') }}">Liste des Fournisseurs</a></li>
            ...
            <li class="slide">
            <li class="side-item side-item-category">Informations de Contact</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/AfficherUser') }}">Liste des utilisateurs</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'mail-compose')) }}">Ajouter un utilisateur</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='profile') }}">My Profile</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='profile') }}">Edit Profile</a></li>
			...
			<li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-5 7c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10zM4.59 11.59l-.59.58V4h11v7H5.17l-.58.59z" />
                    </svg><span class="side-menu__label">Access Control</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('permissions.index') }}">Permissions</a></li>
                    <li><a class="slide-item" href="{{ route('roles.index') }}">Roles</a>
                    </li>
                </ul>
            </li>
            {{-- <li class="slide">
            ...
            <li class="side-item side-item-category">Paramétres</li>
           
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'produit')) }}"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        <path
                    ...
                    </svg><span class="side-menu__label">Produits</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'produit')) }}">Background</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">Edit Profil</span><i
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">Liste des factures</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='cards') }}">Rapports financiers</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='darggablecards') }}">Rapports clients</a></li>
						</ul>
					</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='mail-compose') }}">Ajouter un utilisateur</a></li>
						</ul>
