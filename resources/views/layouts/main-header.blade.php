...
<<<<<<< HEAD
						{{-- <div class="responsive-logo">
							<p>hello</p>
							{{-- <a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/faces/p2.jpg')}}" class="logo-1" alt="logo"></a> --}}
							{{--<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/logo.jpeg')}}" class="dark-logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/logo.jpeg')}}" class="logo-2" alt="logo"></a>
							
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/logo.jpeg')}}" class="dark-logo-2" alt="logo"></a>
							<p>hello Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur minus, provident nesciunt eveniet iste illum consectetur excepturi saepe qui totam.</p>
						</div> --}}
=======
						<div class="responsive-logo">
...
<<<<<<< HEAD
									{{-- <a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/faces/p2.jpg')}}" alt="img"></span>
								...
								<div class="dropdown-menu">
									...
									{{-- <div class="main-message-list chat-scroll">
										<a href="#" class="p-3 d-flex border-bottom">
											<div class="  drop-img  cover-image  " data-image-src="{{URL::asset('assets/img/faces/p2.jpg')}}">
										...
										<a href="#" class="p-3 d-flex border-bottom">
											<div class="drop-img cover-image" data-image-src="{{URL::asset('assets/img/faces/1.jpg')}}">
=======
							<div class="dropdown nav-item main-header-message ">
								<a class="new nav-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg><span class=" pulse-danger"></span></a>
								<div class="dropdown-menu">
...
<<<<<<< HEAD
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/p2.jpg')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<!--<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/p2.jpg')}}" class=""></div>-->
											<div class="">
...
<<<<<<< HEAD
									...
									<a class="dropdown-item" href="{{ url('/' . $page='profile') }}"><i class="bx bx-cog"></i> Edit Profile</a>
